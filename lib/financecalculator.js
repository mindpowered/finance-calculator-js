...
$hx_exports["financecalculator"] = $hx_exports["financecalculator"] || {};
...
$hxClasses["Type"] = Type;
Type.__name__ = "Type";
class financecalculator_FinCalc {
	constructor() {
	}
	futureValue(presentValue,numPeriods,interestRate,timesCompoundedPerPeriod,depositAmount,depositAtBeginning) {
		let ir = interestRate / 100.0;
		let fvps = presentValue * Math.pow(1 + ir,numPeriods);
		let fv = depositAmount / ir;
		fv *= Math.pow(1 + ir,numPeriods) - 1.0;
		if(depositAtBeginning) {
			fv *= 1.0 + ir;
		}
		let totalDeposits = numPeriods * depositAmount + presentValue;
		let futureValue = fv + fvps;
		let totalInterest = futureValue - totalDeposits;
		...
		return { futureValue : futureValue, totalInterest : totalInterest, totalDeposits : totalDeposits};
	}
}
$hxClasses["financecalculator.FinCalc"] = financecalculator_FinCalc;
financecalculator_FinCalc.__name__ = "financecalculator.FinCalc";
Object.assign(financecalculator_FinCalc.prototype, {
	__class__: financecalculator_FinCalc
});
class financecalculator_FinanceCalculator {
	constructor(maglev) {
		this.maglev = maglev;
		this.calc = new financecalculator_FinCalc();
		this.registerMyMethods();
	}
	registerMyMethods() {
		let bus = this.maglev;
		let _gthis = this;
		this.maglev.register("FinanceCalculator.PresentValueOfFutureMoney",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("FinanceCalculator.PresentValueOfFutureMoney"));
			data.push(maglev_MagLevString.fromString("financecalculator"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'FinanceCalculator.PresentValueOfFutureMoney' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("FinanceCalculator.PresentValueOfDeposits",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("FinanceCalculator.PresentValueOfDeposits"));
			data.push(maglev_MagLevString.fromString("financecalculator"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'FinanceCalculator.PresentValueOfDeposits' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("FinanceCalculator.FutureValue",maglev_MagLevFunction.fromFunction(function(args) {
			let presentValue = (js_Boot.__cast(args.get(0) , maglev_MagLevNumber)).getFloat();
			let numPeriods = (js_Boot.__cast(args.get(1) , maglev_MagLevNumber)).getInt();
			let interestRate = (js_Boot.__cast(args.get(2) , maglev_MagLevNumber)).getFloat();
			let timesCompoundedPerPeriod = (js_Boot.__cast(args.get(3) , maglev_MagLevNumber)).getInt();
			let depositAmount = (js_Boot.__cast(args.get(4) , maglev_MagLevNumber)).getFloat();
			let depositAtBeginning = (js_Boot.__cast(args.get(5) , maglev_MagLevBoolean)).getBool();
			let ret = _gthis.calc.futureValue(presentValue,numPeriods,interestRate,timesCompoundedPerPeriod,depositAmount,depositAtBeginning);
			let resobj = maglev_MagLevObject.create();
			resobj.set("futureValue",maglev_MagLevNumber.fromFloat(ret.futureValue));
			resobj.set("totalInterest",maglev_MagLevNumber.fromFloat(ret.totalInterest));
			let result = maglev_MagLevResult.fromResult(resobj);
			return result;
		}));
		this.maglev.register("FinanceCalculator.NetPresentValue",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("FinanceCalculator.NetPresentValue"));
			data.push(maglev_MagLevString.fromString("financecalculator"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'FinanceCalculator.NetPresentValue' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
	}
}
$hxClasses["financecalculator.FinanceCalculator"] = $hx_exports["financecalculator"]["FinanceCalculator"] = financecalculator_FinanceCalculator;
financecalculator_FinanceCalculator.__name__ = "financecalculator.FinanceCalculator";
Object.assign(financecalculator_FinanceCalculator.prototype, {
	__class__: financecalculator_FinanceCalculator
	,maglev: null
	,calc: null
});
...
var financecalculator = $hx_exports["financecalculator"];
